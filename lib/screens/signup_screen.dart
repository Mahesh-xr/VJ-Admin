...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  final _superKeyController = TextEditingController();
  ...
  Future<void> _signUp() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final isValidSuperKey = await SuperAdminService.verifySuperKey(_superKeyController.text.trim());
        if (!isValidSuperKey) {
          setState(() => _isLoading = false);
          _showSnackBar('Invalid super key. Please check with your administrator.', backgroundColor: Colors.red);
          return;
        }
  ...
  Widget _buildSuperKeyField() {
    return TextFormField(
      controller: _superKeyController,
      obscureText: _obscureSuperKey,
      enabled: !_isLoading,
      decoration: InputDecoration(
        hintText: 'Enter super key provided by administrator',
      ...
      validator: (value) {
        if (value == null || value.trim().isEmpty) {
          return 'Please enter the super key';
        }
        return null;
      },
    );
